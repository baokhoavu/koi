...
function getDailyIncrements() {
	...
	return {
		to20RFIDaily: Math.floor(Math.random() * 8) + 3,
		to20RidersDaily: Math.floor(Math.random() * 12) + 5,
		to20Riders2Daily: Math.floor(Math.random() * 8) + 3,
		to20OneDayDaily: Math.floor(Math.random() * 6) + 2,
		to20OneDayDaily2: Math.floor(Math.random() * 5) + 1,
		to20VRDaily: Math.floor(Math.random() * 6) + 2,
		to20theHammerDaily: Math.floor(Math.random() * 4) + 1,
		to20CrewDaily: Math.floor(Math.random() * 4) + 2,
		to20DonDaily: '$' + (Math.floor(Math.random() * 25000) + 5000).toLocaleString() + '.00',
		to20RegFeeDaily: '$' + (Math.floor(Math.random() * 2500) + 500).toLocaleString() + '.00',
		
		ab20RFIDaily: Math.floor(Math.random() * 6) + 2,
		ab20RidersDaily: Math.floor(Math.random() * 8) + 3,
		ab20Riders2Daily: Math.floor(Math.random() * 5) + 2,
		ab20VRDaily: Math.floor(Math.random() * 4) + 1,
		ab20CrewDaily: Math.floor(Math.random() * 3) + 1,
		ab20DonDaily: '$' + (Math.floor(Math.random() * 18000) + 3500).toLocaleString() + '.00',
		ab20RegFeeDaily: '$' + (Math.floor(Math.random() * 1800) + 350).toLocaleString() + '.00',
		...
		owto20VRDaily: Math.floor(Math.random() * 4) + 1,
		owto20CrewsDaily: Math.floor(Math.random() * 3) + 1,
		owto20WalkersDaily: Math.floor(Math.random() * 8) + 3,
		owto20NightWalkersDaily: Math.floor(Math.random() * 5) + 2,
		owto202dayDaily: Math.floor(Math.random() * 4) + 1,
		owto2025kmWalkersDaily: Math.floor(Math.random() * 3) + 1,
		owto2040kmWalkersDaily: Math.floor(Math.random() * 2) + 1,
		owto20DonDaily: '$' + (Math.floor(Math.random() * 18000) + 4000).toLocaleString() + '.00',
		owto20RegDaily: '$' + (Math.floor(Math.random() * 1800) + 400).toLocaleString() + '.00',
		
		owto19RFIDaily: Math.floor(Math.random() * 5) + 2,
		owto19VRDaily: Math.floor(Math.random() * 3) + 1,
		...
		owto19RegDaily: '$' + (Math.floor(Math.random() * 1500) + 350).toLocaleString() + '.00',
		
		owto18RFIDaily: Math.floor(Math.random() * 5) + 1,
		owto18VRDaily: Math.floor(Math.random() * 3) + 1,
		...
		owto18RegDaily: '$' + (Math.floor(Math.random() * 1300) + 300).toLocaleString() + '.00',
...
module.exports = (req, res) => {
	...
	try {
		...
		const mockResponse = {
			...
			to20Riders2: Math.floor(locals.getEventTotal.toronto.to20.riders * 0.6),
			to20OneDay: Math.floor(locals.getEventTotal.toronto.to20.riders * 0.3),
			to20OneDay2: Math.floor(locals.getEventTotal.toronto.to20.riders * 0.2),
			to20VR: locals.getEventTotal.toronto.to20.virtual,
			to20theHammer: Math.floor(locals.getEventTotal.toronto.to20.riders * 0.15),
			...
			to19Riders2: Math.floor(locals.getEventTotal.toronto.to19.riders * 0.6),
			to19OneDay: Math.floor(locals.getEventTotal.toronto.to19.riders * 0.3),
			to19OneDay2: Math.floor(locals.getEventTotal.toronto.to19.riders * 0.2),
			to19VR: locals.getEventTotal.toronto.to19.virtual,
			to19theHammer: Math.floor(locals.getEventTotal.toronto.to19.riders * 0.15),
			...
			to18Riders2: Math.floor(locals.getEventTotal.toronto.to18.riders * 0.6),
			to18OneDay: Math.floor(locals.getEventTotal.toronto.to18.riders * 0.3),
			to18OneDay2: Math.floor(locals.getEventTotal.toronto.to18.riders * 0.2),
			...
			ab20Riders2: Math.floor(locals.getEventTotal.alberta.ab20.riders * 0.7),
			...
			ab19Riders2: Math.floor(locals.getEventTotal.alberta.ab19.riders * 0.7),
			...
			owTo20VR: locals2.getEventTotal.toronto.owTo20.walkers, // Virtual walkers
			owTo20Crews: locals2.getEventTotal.toronto.owTo20.crews,
			owTo20Walkers: locals2.getEventTotal.toronto.owTo20.walkers,
			owTo20NightWalkers: Math.floor(locals2.getEventTotal.toronto.owTo20.walkers * 0.4),
			owTo202day: Math.floor(locals2.getEventTotal.toronto.owTo20.walkers * 0.3),
			owTo2025kmWalkers: Math.floor(locals2.getEventTotal.toronto.owTo20.walkers * 0.25),
			owTo2040kmWalkers: Math.floor(locals2.getEventTotal.toronto.owTo20.walkers * 0.2),
			...
			owto20RegDaily: dailyIncrements.owto20RegDaily,
			...
			owTo19VR: locals2.getEventTotal.toronto.owTo19.walkers, // Virtual walkers
			owTo19Crews: locals2.getEventTotal.toronto.owTo19.crews,
			owTo19Walkers: locals2.getEventTotal.toronto.owTo19.walkers,
			owTo19NightWalkers: Math.floor(locals2.getEventTotal.toronto.owTo19.walkers * 0.4),
			owTo192day: Math.floor(locals2.getEventTotal.toronto.owTo19.walkers * 0.3),
			owTo1925kmWalkers: Math.floor(locals2.getEventTotal.toronto.owTo19.walkers * 0.25),
			owTo1940kmWalkers: Math.floor(locals2.getEventTotal.toronto.owTo19.walkers * 0.2),
			...
			owto19RegDaily: dailyIncrements.owto19RegDaily,
			...
			owTo18VR: locals2.getEventTotal.toronto.owTo18.walkers, // Virtual walkers
			owTo18Crews: locals2.getEventTotal.toronto.owTo18.crews,
			owTo18Walkers: locals2.getEventTotal.toronto.owTo18.walkers,
			owTo18NightWalkers: Math.floor(locals2.getEventTotal.toronto.owTo18.walkers * 0.4),
			owTo182day: Math.floor(locals2.getEventTotal.toronto.owTo18.walkers * 0.3),
			owTo1815kmWalkers: Math.floor(locals2.getEventTotal.toronto.owTo18.walkers * 0.15),
			owTo1825kmWalkers: Math.floor(locals2.getEventTotal.toronto.owTo18.walkers * 0.25),
			owTo1840kmWalkers: Math.floor(locals2.getEventTotal.toronto.owTo18.walkers * 0.2),
			...
			owto18RegDaily: dailyIncrements.owto18RegDaily,
			...
			owTo1715kmWalkers: Math.floor(locals2.getEventTotal.toronto.owTo17.walkers * 0.15),
			owTo1725kmWalkers: Math.floor(locals2.getEventTotal.toronto.owTo17.walkers * 0.25),
			owTo1740kmWalkers: Math.floor(locals2.getEventTotal.toronto.owTo17.walkers * 0.2),
