											...
											if (!err && response.statusCode === 200) {
												...
												data.findOne({ updated: moment().format('L') })
													...
													.exec((err, latestdata) => {
														...
														if (latestdata) {
															console.log(
																`Getting latest data! Date: ${latestdata.updated}`
															);
															...
															var _removeRegPr17v1 = latestdata.pr17RegFee;
															var _removeRegPr17v2 = yesterday[0].pr17RegFee;
															...
															var _owTo19Virtual =
																locals2.getEventTotal.toronto.to19.virtual;
															var owTo1925kmWalkers =
																locals2.getEventTotal.toronto.to19.Wlkr25km;
															var owTo19NightWalkers =
																locals2.getEventTotal.toronto.to19.nightWlk;
															var owTo192day =
																locals2.getEventTotal.toronto.to19.twoDayWlk;
															...
															var owTo18NightWalkers =
																locals2.getEventTotal.toronto.to18.nightWlk;
															var owTo182day =
																locals2.getEventTotal.toronto.to18.twoDayWlk;
															var owTo1815kmWalkers =
																locals2.getEventTotal.toronto.to18.Wlkr15km;
															var owTo1825kmWalkers =
																locals2.getEventTotal.toronto.to18.Wlkr25km;
															var owTo1840kmWalkers =
																locals2.getEventTotal.toronto.to18.Wlkr40km;
															...
															var owTo1715kmWalkers =
																locals2.getEventTotal.toronto.to17.Wlkr15km;
															var owTo1725kmWalkers =
																locals2.getEventTotal.toronto.to17.Wlkr25km;
															var owTo1740kmWalkers =
																locals2.getEventTotal.toronto.to17.Wlkr40km;
															...
															// Toronto
															var numberTo19v1 = Number(
																removeDollarTo19v1.replace(/[^0-9.-]+/g, '')
															);
															var numberTo19v2 = Number(
																removeDollarTo19v2.replace(/[^0-9.-]+/g, '')
															);
															var numberRegTo19v1 = Number(
																removeRegTo19v1.replace(/[^0-9.-]+/g, '')
															);
															var numberRegTo19v2 = Number(
																removeRegTo19v2.replace(/[^0-9.-]+/g, '')
															);
															var numberTo18v1 = Number(
																removeDollarTo18v1.replace(/[^0-9.-]+/g, '')
															);
															var numberTo18v2 = Number(
																removeDollarTo18v2.replace(/[^0-9.-]+/g, '')
															);
															var numberTo17v1 = Number(
																removeDollarTo17v1.replace(/[^0-9.-]+/g, '')
															);
															var numberTo17v2 = Number(
																removeDollarTo17v2.replace(/[^0-9.-]+/g, '')
															);
															var numberRegTo18v1 = Number(
																removeRegTo18v1.replace(/[^0-9.-]+/g, '')
															);
															var numberRegTo18v2 = Number(
																removeRegTo18v2.replace(/[^0-9.-]+/g, '')
															);

															var numberPr18v1 = Number(
																removeDollarPr18v1.replace(/[^0-9.-]+/g, '')
															);
															var numberPr18v2 = Number(
																removeDollarPr18v2.replace(/[^0-9.-]+/g, '')
															);
															var numberPr17v1 = Number(
																removeDollarPr17v1.replace(/[^0-9.-]+/g, '')
															);
															var numberPr17v2 = Number(
																removeDollarPr17v2.replace(/[^0-9.-]+/g, '')
															);
															var numberRegPr18v1 = Number(
																removeRegPr18v1.replace(/[^0-9.-]+/g, '')
															);
															var numberRegPr18v2 = Number(
																removeRegPr18v2.replace(/[^0-9.-]+/g, '')
															);

															var numberMo19v1 = Number(
																removeDollarMo19v1.replace(/[^0-9.-]+/g, '')
															);
															var numberMo19v2 = Number(
																removeDollarMo19v2.replace(/[^0-9.-]+/g, '')
															);
															var numberRegMo19v1 = Number(
																removeRegMo19v1.replace(/[^0-9.-]+/g, '')
															);
															var numberRegMo19v2 = Number(
																removeRegMo19v2.replace(/[^0-9.-]+/g, '')
															);
															var numberMo18v1 = Number(
																removeDollarMo18v1.replace(/[^0-9.-]+/g, '')
															);
															var numberMo18v2 = Number(
																removeDollarMo18v2.replace(/[^0-9.-]+/g, '')
															);
															var numberMo17v1 = Number(
																removeDollarMo17v1.replace(/[^0-9.-]+/g, '')
															);
															var numberMo17v2 = Number(
																removeDollarMo17v2.replace(/[^0-9.-]+/g, '')
															);
															var numberRegMo18v1 = Number(
																removeRegMo18v1.replace(/[^0-9.-]+/g, '')
															);
															var numberRegMo18v2 = Number(
																removeRegMo18v2.replace(/[^0-9.-]+/g, '')
															);

															var numberAb19v1 = Number(
																removeDollarAb19v1.replace(/[^0-9.-]+/g, '')
															);
															var numberAb19v2 = Number(
																removeDollarAb19v2.replace(/[^0-9.-]+/g, '')
															);
															var numberRegAb19v1 = Number(
																removeRegAb19v1.replace(/[^0-9.-]+/g, '')
															);
															var numberRegAb19v2 = Number(
																removeRegAb19v2.replace(/[^0-9.-]+/g, '')
															);
															var numberAb18v1 = Number(
																removeDollarAb18v1.replace(/[^0-9.-]+/g, '')
															);
															var numberAb18v2 = Number(
																removeDollarAb18v2.replace(/[^0-9.-]+/g, '')
															);
															var numberAb17v1 = Number(
																removeDollarAb17v1.replace(/[^0-9.-]+/g, '')
															);
															var numberAb17v2 = Number(
																removeDollarAb17v2.replace(/[^0-9.-]+/g, '')
															);
															var numberRegAb18v1 = Number(
																removeRegAb18v1.replace(/[^0-9.-]+/g, '')
															);
															var numberRegAb18v2 = Number(
																removeRegAb18v2.replace(/[^0-9.-]+/g, '')
															);

															var numberVa19v1 = Number(
																removeDollarVa19v1.replace(/[^0-9.-]+/g, '')
															);
															var numberVa19v2 = Number(
																removeDollarVa19v2.replace(/[^0-9.-]+/g, '')
															);
															var numberRegVa19v1 = Number(
																removeRegVa19v1.replace(/[^0-9.-]+/g, '')
															);
															var numberRegVa19v2 = Number(
																removeRegVa19v2.replace(/[^0-9.-]+/g, '')
															);
															var numberVa18v1 = Number(
																removeDollarVa18v1.replace(/[^0-9.-]+/g, '')
															);
															var numberVa18v2 = Number(
																removeDollarVa18v2.replace(/[^0-9.-]+/g, '')
															);
															var numberVa17v1 = Number(
																removeDollarVa17v1.replace(/[^0-9.-]+/g, '')
															);
															var numberVa17v2 = Number(
																removeDollarVa17v2.replace(/[^0-9.-]+/g, '')
															);
															var numberRegVa18v1 = Number(
																removeRegVa18v1.replace(/[^0-9.-]+/g, '')
															);
															var numberRegVa18v2 = Number(
																removeRegVa18v2.replace(/[^0-9.-]+/g, '')
															);

															var numberOwTo19v1 = Number(
																removeDollarOwTo19v1.replace(/[^0-9.-]+/g, '')
															);
															var numberOwTo19v2 = Number(
																removeDollarOwTo19v2.replace(/[^0-9.-]+/g, '')
															);
															var numberOwTo18v1 = Number(
																removeDollarOwTo18v1.replace(/[^0-9.-]+/g, '')
															);
															var numberOwTo18v2 = Number(
																removeDollarOwTo18v2.replace(/[^0-9.-]+/g, '')
															);
															var numberOwTo17v1 = Number(
																removeDollarOwTo17v1.replace(/[^0-9.-]+/g, '')
															);
															var numberOwTo17v2 = Number(
																removeDollarOwTo17v2.replace(/[^0-9.-]+/g, '')
															);
															var numberRegOwTo19v1 = Number(
																removeRegOwTo19v1.replace(/[^0-9.-]+/g, '')
															);
															var numberRegOwTo19v2 = Number(
																removeRegOwTo19v2.replace(/[^0-9.-]+/g, '')
															);
															var numberRegOwTo18v1 = Number(
																removeRegOwTo18v1.replace(/[^0-9.-]+/g, '')
															);
															var numberRegOwTo18v2 = Number(
																removeRegOwTo18v2.replace(/[^0-9.-]+/g, '')
															);

															var numberBr18v1 = Number(
																removeDollarBr18v1.replace(/[^0-9.-]+/g, '')
															);
															var numberBr18v2 = Number(
																removeDollarBr18v2.replace(/[^0-9.-]+/g, '')
															);
															var numberRegBr18v1 = Number(
																removeRegBr18v1.replace(/[^0-9.-]+/g, '')
															);
															var numberRegBr18v2 = Number(
																removeRegBr18v2.replace(/[^0-9.-]+/g, '')
															);

															var numberMl18v1 = Number(
																removeDollarMl18v1.replace(/[^0-9.-]+/g, '')
															);
															var numberMl18v2 = Number(
																removeDollarMl18v2.replace(/[^0-9.-]+/g, '')
															);
															var numberMl17v1 = Number(
																removeDollarMl17v1.replace(/[^0-9.-]+/g, '')
															);
															var numberMl17v2 = Number(
																removeDollarMl17v2.replace(/[^0-9.-]+/g, '')
															);
															var numberRegMl18v1 = Number(
																removeRegMl18v1.replace(/[^0-9.-]+/g, '')
															);
															var numberRegMl18v2 = Number(
																removeRegMl18v2.replace(/[^0-9.-]+/g, '')
															);
															...
															var to19RfiSub =
																locals.getEventTotal.toronto.to19.rfi -
																yesterday[0].to19RFI;
															var to19CrewSub =
																locals.getEventTotal.toronto.to19.crews -
																yesterday[0].to19Crews;
															...
															var to19Riders2Daily =
																locals.getEventTotal.toronto.to19.riders2 -
																yesterday[0].to19Riders2;
															var to19OneDayDaily =
																locals.getEventTotal.toronto.to19.oneday -
																yesterday[0].to19OneDay;
															var _to19OneDayDaily2 =
																locals.getEventTotal.toronto.to19.oneday2 -
																yesterday[0].to19OneDay2;
															...
															var to18Riders2Daily =
																locals.getEventTotal.toronto.to18.riders2 -
																yesterday[0].to18Riders2;
															var to18OneDayDaily =
																locals.getEventTotal.toronto.to18.oneday -
																yesterday[0].to18OneDay;
															var _to18OneDayDaily2 =
																locals.getEventTotal.toronto.to18.oneday2 -
																yesterday[0].to18OneDay2;
															...
															var mo19VRDaily =
																...
																yesterday[0].mo19VR;
															var mo19Riders2Daily =
																locals.getEventTotal.montreal.mo19.riders2 -
																yesterday[0].mo19Riders2;
															var mo19OneDayDaily =
																locals.getEventTotal.montreal.mo19.oneday -
																yesterday[0].mo19OneDay;
															var mo19OneDayDaily2 =
																locals.getEventTotal.montreal.mo19.oneday2 -
																yesterday[0].mo19OneDay2;
															var mo19DonationSub = numberMo19v1 - numberMo19v2;
															var mo19RfiSub =
																locals.getEventTotal.montreal.mo19.rfi -
																yesterday[0].mo19RFI;
															var mo19CrewSub =
																locals.getEventTotal.montreal.mo19.crews -
																yesterday[0].mo19Crews;
															var _mo19RiderSub =
																locals.getEventTotal.montreal.mo19.riders -
																yesterday[0].mo19Riders;

															var mo19TotalRiders =
																locals.getEventTotal.montreal.mo19.riders;
															var mo19RiderSub =
																mo19TotalRiders - yesterday[0].mo19Riders;
															...
															var mo18RfiSub =
																locals.getEventTotal.montreal.mo18.rfi -
																yesterday[0].mo18RFI;
															var mo18CrewSub =
																locals.getEventTotal.montreal.mo18.crews -
																yesterday[0].mo18Crews;
															var mo18RiderSub =
																locals.getEventTotal.montreal.mo18.riders -
																yesterday[0].mo18Riders;
															...
															var ab19VRDaily =
																...
																yesterday[0].ab19VR;
															var ab19Riders2Daily =
																locals.getEventTotal.alberta.ab19.riders2 -
																yesterday[0].ab19Riders2;
															var ab19OneDayDaily =
																locals.getEventTotal.alberta.ab19.oneday -
																yesterday[0].ab19OneDay;
															var ab19OneDayDaily2 =
																locals.getEventTotal.alberta.ab19.oneday2 -
																yesterday[0].ab19OneDay2;
															var ab19DonationSub = numberAb19v1 - numberAb19v2;
															var ab19RfiSub =
																locals.getEventTotal.alberta.ab19.rfi -
																yesterday[0].ab19RFI;
															var ab19CrewSub =
																locals.getEventTotal.alberta.ab19.crews -
																yesterday[0].ab19Crews;
															var _ab19RiderSub =
																locals.getEventTotal.alberta.ab19.riders -
																yesterday[0].ab19Riders;

															var ab19TotalRiders =
																locals.getEventTotal.alberta.ab19.riders;
															var ab19RiderSub =
																ab19TotalRiders - yesterday[0].ab19Riders;
															...
															var ab18RfiSub =
																locals.getEventTotal.alberta.ab18.rfi -
																yesterday[0].ab18RFI;
															var ab18CrewSub =
																locals.getEventTotal.alberta.ab18.crews -
																yesterday[0].ab18Crews;
															var ab18RiderSub =
																locals.getEventTotal.alberta.ab18.riders -
																yesterday[0].ab18Riders;
															...
															var va19VRDaily =
																...
																yesterday[0].va19VR;
															var va19Riders2Daily =
																locals.getEventTotal.vancouver.va19.riders2 -
																yesterday[0].va19Riders2;
															var va19OneDayDaily =
																locals.getEventTotal.vancouver.va19.oneday -
																yesterday[0].va19OneDay;
															var va19OneDayDaily2 =
																locals.getEventTotal.vancouver.va19.oneday2 -
																yesterday[0].va19OneDay2;
															var va19DonationSub = numberVa19v1 - numberVa19v2;
															var va19RfiSub =
																locals.getEventTotal.vancouver.va19.rfi -
																yesterday[0].va19RFI;
															var va19CrewSub =
																locals.getEventTotal.vancouver.va19.crews -
																yesterday[0].va19Crews;
															var va19RiderSub =
																locals.getEventTotal.vancouver.va19.riders -
																yesterday[0].va19Riders;

															var _va19TotalRiders =
																locals.getEventTotal.vancouver.va19.riders;
															...
															var _owto19RfiSub =
																locals2.getEventTotal.toronto.to19.rfi -
																yesterday[0].owTo19RFI;
															var _owto19CrewsDailySub =
																locals2.getEventTotal.toronto.to19.crews -
																yesterday[0].owTo19Crews;
															var owto19TotalWalkers =
																parseFloat(owTo19NightWalkers) +
																parseFloat(owTo1925kmWalkers) +
																parseFloat(owTo182day);
															var _owto19VirtualDailySub =
																owto19Virtual - yesterday[0].owto19Virtual;
															var _owto19WalkersDailySub =
																owto19TotalWalkers - yesterday[0].owTo19Walkers;
															var _owTo1925kmWalkersDaily =
																locals2.getEventTotal.toronto.to19.Wlkr25km -
																yesterday[0].owTo1925kmWalkers;
															var _owTo19NightWalkersDaily =
																locals2.getEventTotal.toronto.to19.nightWlk -
																yesterday[0].owTo19NightWalkers;
															var _owTo192dayDaily =
																locals2.getEventTotal.toronto.to19.Wlkr15km -
																yesterday[0].owTo192day;

															var owto18DonationSub = numberOwTo18v1 - numberOwTo18v2;
															var owto17DonationSub = numberOwTo17v1 - numberOwTo17v2;
															var owto18RfiSub =
																locals2.getEventTotal.toronto.to18.rfi -
																yesterday[0].owTo18RFI;
															...
															var owto18CrewsDailySub =
																locals2.getEventTotal.toronto.to18.crews -
																yesterday[0].owTo18Crews;
															var owto18WalkersDailySub =
																owto18TotalWalkers - yesterday[0].owTo18Walkers;
															var owTo182dayDailySub =
																locals2.getEventTotal.toronto.to18.Wlkr15km -
																yesterday[0].owTo182day;
															var owTo1815kmWalkersDailySub =
																locals2.getEventTotal.toronto.to18.Wlkr15km -
																yesterday[0].owTo1815kmWalkers;
															var owTo1825kmWalkersDailySub =
																locals2.getEventTotal.toronto.to18.Wlkr25km -
																yesterday[0].owTo1825kmWalkers;
															var owTo1840kmWalkersDailySub =
																locals2.getEventTotal.toronto.to18.Wlkr40km -
																yesterday[0].owTo1840kmWalkers;
															var owTo18NightWalkersDailySub =
																locals2.getEventTotal.toronto.to18.nightWlk -
																yesterday[0].owTo18NightWalkers;
															...
															var br18RiderSub =
																...
																yesterday[0].br18Riders;

															var br18WalkerSub =
																locals4.getEventTotal.brisbane.br18.walkers -
																yesterday[0].br18Walkers;
															...
															var ml18RiderSub =
																...
																yesterday[0].ml18Riders;
															var _ml18WalkerSub =
																locals4.getEventTotal.melbourne.ml18.walkers -
																yesterday[0].ml18Walkers;
															...
															var newOwTo19DonDaily =
																...
																owto19DonationSub
																	.toFixed(2)
																	.replace(/(\d)(?=(\d\d\d)+(?!\d))/g, '$1,');
															var newOwTo19RegDaily =
																'$' +
																owto19RegSub
																	.toFixed(2)
																	.replace(/(\d)(?=(\d\d\d)+(?!\d))/g, '$1,');
															var _newOwToDonDaily =
																'$' +
																owto18DonationSub
																	.toFixed(2)
																	.replace(/(\d)(?=(\d\d\d)+(?!\d))/g, '$1,');
															...
															// RIDE - Toronto - 2019
															latestdata.to19Donations =
																locals.getEventTotal.toronto.to19.totalDonation;
															latestdata.to19RegFee =
																locals.getEventTotal.toronto.to19.regFee;
															latestdata.to19Crews =
																locals.getEventTotal.toronto.to19.crews;
															latestdata.to19RFI = locals.getEventTotal.toronto.to19.rfi;
															latestdata.to19Riders = to19TotalRiders;
															latestdata.to19VR =
																locals.getEventTotal.toronto.to19.virtual;
															latestdata.to19Riders2 =
																locals.getEventTotal.toronto.to19.riders2;
															latestdata.to19OneDay =
																locals.getEventTotal.toronto.to19.oneday;
															latestdata.to19OneDay2 =
																locals.getEventTotal.toronto.to19.oneday2;
															latestdata.to19TotalParticipants = to19TotalParticipants;

															// RIDE - Toronto - 2018
															latestdata.to18Donations =
																locals.getEventTotal.toronto.to18.totalDonation;
															latestdata.to18RegFee =
																locals.getEventTotal.toronto.to18.regFee;
															latestdata.to18Crews =
																locals.getEventTotal.toronto.to18.crews;
															latestdata.to18RFI = locals.getEventTotal.toronto.to18.rfi;
															latestdata.to18Riders = to18TotalRiders;
															latestdata.to18VR =
																locals.getEventTotal.toronto.to18.virtual;
															latestdata.to18Riders2 =
																locals.getEventTotal.toronto.to18.riders2;
															latestdata.to18OneDay =
																locals.getEventTotal.toronto.to18.oneday;
															latestdata.to18OneDay2 =
																locals.getEventTotal.toronto.to18.oneday2;
															latestdata.to18TotalParticipants = to18TotalParticipants;

															latestdata.to17Donations =
																locals.getEventTotal.toronto.to17.totalDonation;
															latestdata.to17RegFee =
																locals.getEventTotal.toronto.to17.regFee;
															latestdata.to17Crews =
																locals.getEventTotal.toronto.to17.crews;
															latestdata.to17RFI = locals.getEventTotal.toronto.to17.rfi;
															latestdata.to17Riders =
																locals.getEventTotal.toronto.to17.riders;
															latestdata.to17VR =
																locals.getEventTotal.toronto.to17.virtual;

															// RIDE - Montreal - 2019
															latestdata.mo19Donations =
																locals.getEventTotal.montreal.mo19.totalDonation;
															latestdata.mo19RegFee =
																locals.getEventTotal.montreal.mo19.regFee;
															latestdata.mo19Crews =
																locals.getEventTotal.montreal.mo19.crews;
															latestdata.mo19RFI = locals.getEventTotal.montreal.mo19.rfi;
															latestdata.mo19Riders = mo19TotalRiders;
															latestdata.mo19VR =
																locals.getEventTotal.montreal.mo19.virtual;
															latestdata.mo19Riders2 =
																locals.getEventTotal.montreal.mo19.riders2;
															latestdata.mo19OneDay =
																locals.getEventTotal.montreal.mo19.oneday;
															latestdata.mo19OneDay2 =
																locals.getEventTotal.montreal.mo19.oneday2;
															latestdata.mo19TotalParticipants = mo19TotalParticipants;

															// RIDE - Montreal * 2018
															latestdata.mo18Donations =
																locals.getEventTotal.montreal.mo18.totalDonation;
															latestdata.mo18RegFee =
																locals.getEventTotal.montreal.mo18.regFee;
															latestdata.mo18Crews =
																locals.getEventTotal.montreal.mo18.crews;
															latestdata.mo18RFI = locals.getEventTotal.montreal.mo18.rfi;
															latestdata.mo18Riders =
																locals.getEventTotal.montreal.mo18.riders;
															latestdata.mo18VR =
																locals.getEventTotal.montreal.mo18.virtual;

															latestdata.mo17Donations =
																locals.getEventTotal.montreal.mo17.totalDonation;
															latestdata.mo17RegFee =
																locals.getEventTotal.montreal.mo17.regFee;
															latestdata.mo17Crews =
																locals.getEventTotal.montreal.mo17.crews;
															latestdata.mo17RFI = locals.getEventTotal.montreal.mo17.rfi;
															latestdata.mo17Riders =
																locals.getEventTotal.montreal.mo17.riders;
															latestdata.mo17VR =
																locals.getEventTotal.montreal.mo17.virtual;

															// RIDE - Alberta
															latestdata.ab19Donations =
																locals.getEventTotal.alberta.ab19.totalDonation;
															latestdata.ab19RegFee =
																locals.getEventTotal.alberta.ab19.regFee;
															latestdata.ab19Crews =
																locals.getEventTotal.alberta.ab19.crews;
															latestdata.ab19RFI = locals.getEventTotal.alberta.ab19.rfi;
															latestdata.ab19Riders =
																locals.getEventTotal.alberta.ab19.riders;
															//latestdata.ab19Riders = to19TotalRiders;
															latestdata.ab19VR =
																locals.getEventTotal.alberta.ab19.virtual;
															latestdata.ab19Riders2 =
																locals.getEventTotal.alberta.ab19.riders2;
															latestdata.ab19OneDay =
																locals.getEventTotal.alberta.ab19.oneday;
															latestdata.ab19OneDay2 =
																locals.getEventTotal.alberta.ab19.oneday2;
															latestdata.ab19TotalParticipants = ab19TotalParticipants;

															latestdata.ab18Donations =
																locals.getEventTotal.alberta.ab18.totalDonation;
															latestdata.ab18RegFee =
																locals.getEventTotal.alberta.ab18.regFee;
															latestdata.ab18Crews =
																locals.getEventTotal.alberta.ab18.crews;
															latestdata.ab18RFI = locals.getEventTotal.alberta.ab18.rfi;
															latestdata.ab18Riders =
																locals.getEventTotal.alberta.ab18.riders;
															latestdata.ab18VR =
																locals.getEventTotal.alberta.ab18.virtual;

															latestdata.ab17Donations =
																locals.getEventTotal.alberta.ab17.totalDonation;
															latestdata.ab17RegFee =
																locals.getEventTotal.alberta.ab17.regFee;
															latestdata.ab17Crews =
																locals.getEventTotal.alberta.ab17.crews;
															latestdata.ab17RFI = locals.getEventTotal.alberta.ab17.rfi;
															latestdata.ab17Riders =
																locals.getEventTotal.alberta.ab17.riders;
															latestdata.ab17VR =
																locals.getEventTotal.alberta.ab17.virtual;

															// RIDE - Vancouver
															latestdata.va19Donations =
																locals.getEventTotal.vancouver.va19.totalDonation;
															latestdata.va19RegFee =
																locals.getEventTotal.vancouver.va19.regFee;
															latestdata.va19Crews =
																locals.getEventTotal.vancouver.va19.crews;
															latestdata.va19RFI =
																locals.getEventTotal.vancouver.va19.rfi;
															latestdata.va19Riders =
																locals.getEventTotal.vancouver.va19.riders;
															latestdata.va19VR =
																locals.getEventTotal.vancouver.va19.virtual;
															latestdata.va19Riders2 =
																locals.getEventTotal.vancouver.va19.riders2;
															latestdata.va19OneDay =
																locals.getEventTotal.vancouver.va19.oneday;
															latestdata.va19OneDay2 =
																locals.getEventTotal.vancouver.va19.oneday2;
															latestdata.va19TotalParticipants = va19TotalParticipants;

															latestdata.va18Donations =
																locals.getEventTotal.vancouver.va18.totalDonation;
															latestdata.va18RegFee =
																locals.getEventTotal.vancouver.va18.regFee;
															latestdata.va18Crews =
																locals.getEventTotal.vancouver.va18.crews;
															latestdata.va18RFI =
																locals.getEventTotal.vancouver.va18.rfi;
															latestdata.va18Riders =
																locals.getEventTotal.vancouver.va18.riders;
															latestdata.va18VR =
																locals.getEventTotal.vancouver.va18.virtual;

															latestdata.va17Donations =
																locals.getEventTotal.vancouver.va17.totalDonation;
															latestdata.va17RegFee =
																locals.getEventTotal.vancouver.va17.regFee;
															latestdata.va17Crews =
																locals.getEventTotal.vancouver.va17.crews;
															latestdata.va17RFI =
																locals.getEventTotal.vancouver.va17.rfi;
															latestdata.va17Riders =
																locals.getEventTotal.vancouver.va17.riders;
															latestdata.va17VR =
																locals.getEventTotal.vancouver.va17.virtual;

															// ONEWALK - Toronto
															latestdata.owTo19Donations =
																locals2.getEventTotal.toronto.to19.totalDonation;
															latestdata.owTo19RegFee =
																locals2.getEventTotal.toronto.to19.regFee;
															latestdata.owTo19RFI =
																locals2.getEventTotal.toronto.to19.rfi;
															latestdata.owTo19Crews =
																locals2.getEventTotal.toronto.to19.crews;
															...
															latestdata.owTo18Donations =
																locals2.getEventTotal.toronto.to18.totalDonation;
															latestdata.owTo18RegFee =
																locals2.getEventTotal.toronto.to18.regFee;
															latestdata.owTo18Crews =
																locals2.getEventTotal.toronto.to18.crews;
															...
															latestdata.owTo18RFI =
																locals2.getEventTotal.toronto.to18.rfi;

															latestdata.owTo17Donations =
																locals2.getEventTotal.toronto.to17.totalDonation;
															latestdata.owTo17RegFee =
																locals2.getEventTotal.toronto.to17.regFee;
															latestdata.owTo17Crews =
																locals2.getEventTotal.toronto.to17.crews;
															latestdata.owTo17Walkers =
																locals2.getEventTotal.toronto.to17.walkers;
															...
															latestdata.owTo17RFI =
																locals2.getEventTotal.toronto.to17.rfi;

															// RIDE - Perth
															latestdata.pr18Donations =
																locals3.getEventTotal.perth.pr18.totalDonation;
															latestdata.pr18RegFee =
																locals3.getEventTotal.perth.pr18.regFee;
															latestdata.pr18Crews =
																locals3.getEventTotal.perth.pr18.crews;
															latestdata.pr18RFI = locals3.getEventTotal.perth.pr18.rfi;
															latestdata.pr18Riders =
																locals3.getEventTotal.perth.pr18.riders;

															latestdata.pr17Donations =
																locals3.getEventTotal.perth.pr17.totalDonation;
															latestdata.pr17RegFee =
																locals3.getEventTotal.perth.pr17.regFee;
															latestdata.pr17Crews =
																locals3.getEventTotal.perth.pr17.crews;
															latestdata.pr17RFI = locals3.getEventTotal.perth.pr17.rfi;
															latestdata.pr17Riders =
																locals3.getEventTotal.perth.pr17.riders;

															// ONEDAY - Brisbane
															latestdata.br18Donations =
																locals4.getEventTotal.brisbane.br18.totalDonation;
															latestdata.br18RegFee =
																locals4.getEventTotal.brisbane.br18.regFee;
															latestdata.br18Walkers =
																locals4.getEventTotal.brisbane.br18.walkers;
															latestdata.br18Riders =
																locals4.getEventTotal.brisbane.br18.riders;

															latestdata.br17Donations =
																locals4.getEventTotal.brisbane.br17.totalDonation;
															latestdata.br17RegFee =
																locals4.getEventTotal.brisbane.br17.regFee;
															latestdata.br17Walkers =
																locals4.getEventTotal.brisbane.br17.walkers;
															latestdata.br17Riders =
																locals4.getEventTotal.brisbane.br17.riders;

															// ONEDAY - Melbourne
															latestdata.ml18Donations =
																locals4.getEventTotal.melbourne.ml18.totalDonation;
															latestdata.ml18RegFee =
																locals4.getEventTotal.melbourne.ml18.regFee;
															latestdata.ml18Walkers =
																locals4.getEventTotal.melbourne.ml18.walkers;
															latestdata.ml18Riders =
																locals4.getEventTotal.melbourne.ml18.riders;

															latestdata.ml17Donations =
																locals4.getEventTotal.melbourne.ml17.totalDonation;
															latestdata.ml17RegFee =
																locals4.getEventTotal.melbourne.ml17.regFee;
															latestdata.ml17Walkers =
																locals4.getEventTotal.melbourne.ml17.walkers;
															latestdata.ml17Riders =
															...
															(latestdata.owto182dayDaily = owTo182dayDailySub),
																(latestdata.owto18NightWalkersDaily =
																	owTo18NightWalkersDailySub),
																(latestdata.owto1815kmWalkersDaily =
																	owTo1815kmWalkersDailySub),
																(latestdata.owto1825kmWalkersDaily =
																	owTo1825kmWalkersDailySub),
																(latestdata.owto1840kmWalkersDaily =
																	owTo1840kmWalkersDailySub),
